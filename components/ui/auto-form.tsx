...
export const AutoFormSubmit: FC<PropsWithChildren & ButtonProps> = ({
  children,
  ...props
}) => (
...
type FormConfig<SchemaType extends ZodObjectOrWrapped> = {
  formSchema: SchemaType;
  fieldConfig?: FieldConfig<z.infer<SchemaType>>;
};

export const createFormConfig = <SchemaType extends ZodObjectOrWrapped>(
  input: FormConfig<SchemaType>
) => ({ ...input });
